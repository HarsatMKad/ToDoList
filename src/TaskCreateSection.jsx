  ...
  return (
    <div className='create_task_form'>
      <div className='tasks_inputs'>
        <input ref={inputTitleRef} className='create_tasks_input' id='title_tasks_input' type="text" placeholder='Title...'/>
        <input ref={inputBodyRef} className='create_tasks_input' id='body_tasks_input' type="text" placeholder='About...'/>
      </div>
